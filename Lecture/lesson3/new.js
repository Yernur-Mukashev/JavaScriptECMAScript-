...
const Samba4 = createObject(Samba1, 1014778);

// Проверим установку свойств в конструкторе.
console.log(Samba4.serialNumber); // 1014778
...
console.log(Samba4.startCleaning()); // I am the method of VacuumCleaner;
// I am cleaning... I have been started: 1 times.

// Проверим присвоение конструктора.
console.log(Samba4.constructor); // function Object() { [native code] }
...
function Samba(serailNumber) {
    ...
    // Создадим экземпляр нового объекта.
    const Samba5 = new Samba(1014778);
    // Посмотрим на свойства __proto__ и prototype
    console.log(Samba5.__proto__); // {model: "dancing series", power: 200, batterySize: 2100, boxSize: 0.5, workTime: 45, ...}
    console.log(Samba5.prototype); // undefined
    console.log(Samba5.__proto__ === Samba.prototype); // true